...
from utils import configure_page, currency, inject_custom_css


configure_page("Produtos e Servicos")
init_db()
inject_custom_css()

st.title("Produtos e servicos")
st.caption("Cadastre os itens que serao usados na montagem dos orcamentos.")
